...
<!--                            </div>-->
    ...
    <div class="container">
        <div class="properties-listing spacer">
            <a href="buysalerent.html" class="pull-right viewall">View All Listing</a>
                        ...
                        <div class="carousel-inner">
                            ...
                            foreach ($recommend as $rec): ?>
                                <div class="item <?= ($i == 0) ? 'active' : '' ?>">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img src="<?= Common::getImageAdvert($rec)[0] ?>"
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <a href="<?= Common::getUrlAdvert($rec) ?>" class="more">More Detail</a>
                                        </div>
                                    </div>
                                </div>
                                <?php $i++;
